...
namespace utils::MS::window
	...
	HWND base::create_window(const base::create_info& create_info)
		...
		if (!ret) { throw MS::raw::last_error("Failed to create window. Did you forget to create an initializer instance for your window class? (utils::MS::window::initializer)"); }
	...
	initializer::initializer()
		...
		WNDCLASSEXW wcx
			...
			.lpszClassName {base::class_name.data()},
			};
		RegisterClassExW(&wcx);
		}
	initializer::~initializer() { UnregisterClassW(base::class_name.data(), nullptr); }
	}